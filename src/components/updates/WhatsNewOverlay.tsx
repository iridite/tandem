        ...
        >
          ...
          <div className="max-h-[70vh] overflow-y-auto px-6 py-5">
            {hasMarkdown ? (
              ...
              <div className="rounded-xl border border-border bg-surface-elevated/40 p-4 text-sm text-text-muted">
                <p className="mb-3">Release notes are not available right now for this version.</p>
                {releaseUrl ? (
                  <a
                    href={releaseUrl}
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center rounded-lg border border-border bg-surface px-3 py-2 text-sm text-text transition-colors hover:bg-surface-elevated"
                  >
                    View Latest Release
                  </a>
                ) : null}
